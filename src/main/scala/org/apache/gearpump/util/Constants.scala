...
object Constants {
  ...
  val MASTER_CONFIG = "ds-master"
  val WORKER_CONFIG = "ds-worker"
  val UI_CONFIG = "ds-ui"
  val LINUX_CONFIG = "ds-linux" // linux or Mac
  val HOSTNAME = "ds.hostname"
  val LOG_DAEMON_DIR = "ds.log.daemon.dir"
  val LOG_APPLICATION_DIR = "ds.log.application.dir"
//--------------------------------------------
  val CLUSTER_WATCHER = "clusterWatcher"
  val SINGLETON_MANAGER = "singleton"
  val SINGLETON_PROXY = "singletonProxy"

//mysql
//  val DATABASE_URL = "mysql.url"
//  val DATABASE_USERNAME = "mysql.username"
//  val DATABASE_PASSWORD = "mysql.password"
//  val DATABASE_DRIVER = "mysql.driver"
//  val MAX_CONNECTION = "mysql.max-connection"
//  val CONNECTION_NUM ="mysql.connection_num"
//hbase
//  val HBASE_HOSTNAME = "hbase.hostname"
//  val HBASE_PORT = "hbase.port"
//  val HBASE_HOSTNAME_NAME = "hbase.zookeeper.quorum"
//  val HBASE_PORT_NAME = "hbase.zookeeper.property.clientPort"
